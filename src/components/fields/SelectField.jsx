...
export function SelectField({ field, value, onChange, onBlur, error, disabled = false, getFieldOptions }) {
    ...
    return (
        <div className="space-y-2">
            ...
            <Select value={value || ''} onValueChange={handleChange} disabled={disabled || field.ReadOnly || loading}>
                <SelectTrigger
                    id={field.Id}
