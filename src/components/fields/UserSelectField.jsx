...
export function UserSelectField({ field, value, onChange, onBlur, error, disabled = false, getFieldOptions }) {
    ...
    const handleChange = (selectedId) => {
        const user = fieldOptions.find((option) => userId(option) === selectedId) || null
        onChange(user)
        onBlur(user)
    }
    ...
    return (
        <div className="space-y-2">
            ...
            >
                <SelectTrigger id={field.Id} className={error ? 'border-red-300 bg-red-50' : ''}>
